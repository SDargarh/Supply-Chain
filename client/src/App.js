...
class App extends Component {
  ...
  listenToPaymentEvent = () => {
    this.ItemManager.events.SupplyChainStep().on("data", async function(evt){
      console.log(evt);
      let itemObj = this.ItemManager.methods.items(evt.returnValues._itemIndex).call();
      console.log(itemObj);
  ...
  handleSubmit = async() => {
    ...
    console.log(result);
    alert("send " + cost + " in Wei to " + result.events.SupplyChainStep.returnValues._address);
  }
